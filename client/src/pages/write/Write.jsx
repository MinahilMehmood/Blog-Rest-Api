        ...
        <div className="write">
            ...
            <form onSubmit={handleSubmit} className="write-form">
                <div className="write-form-group">
                    ...
                    <input className="write-input" type="text" placeholder="Title" autoFocus={true} onChange={(e) => {
                        setTitle(e.target.value)
                    }} />
                </div>
                <div className="write-form-group">
                    <textarea className="write-input write-text" placeholder="Tell your story..." type="text" onChange={(e) => {
